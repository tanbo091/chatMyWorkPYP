                    ...
                    Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                NetWord netWord = new NetWord("http://2579f0157d.wicp.vip:80/MyForum1/deleteCard",jsonObject,handler);
                ...
                case R.id.top:
                    ...
                    Thread thread1 = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                jsonObject.put("id",((JSONObject)arrayList.get(position)).get("id").toString());
                                NetWord netWord = new NetWord("http://2579f0157d.wicp.vip:80/MyForum1/keepTop",jsonObject,handler);
                                jsonObject = netWord.doPost();
                                if (jsonObject.getString("result").equals("success")) {
