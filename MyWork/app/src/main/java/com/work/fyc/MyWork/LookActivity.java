                    ...
                    Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                NetWord net = new NetWord("http://2579f0157d.wicp.vip:80/MyForum1/replyCard", jsonObject, handler);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    NetWord net = new NetWord("http://2579f0157d.wicp.vip:80/MyForum1/lookReply",json,handler);
                    json = net.doPost();
                    if (json == null) {
                    } else {
