...
public class SendActivity extends AppCompatActivity {
    ...
    private void init() {
        tvToolTitle = (TextView) findViewById(R.id.tvToolTitle);
        tool = (Toolbar) findViewById(R.id.tool);
        spinner = (Spinner) findViewById(R.id.spinner);
        title = (EditText) findViewById(R.id.title_s);
        content = (EditText) findViewById(R.id.content);
        tvToolTitle.setText("发帖");
                    ...
                    Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                NetWord netWord = new NetWord("http://2579f0157d.wicp.vip:80/MyForum1/sendCard", jsonObject, handler);
